...
**Version 2.0.34** [release notes](./2.0.34/README-2.0.34.md).
...
* **STEP 1.** - Put the new Geosupport distribution in the `<project_dir>/dist` directory:
...
* **STEP 2.** - Configure `<project_dir>/release.conf`:
...
* **STEP 3.** - Clean and regenerate the build script:
